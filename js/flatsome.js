!(function (t) {
  ...
  function (t, e, i) {
    ...
    var n = document.body,
      ...
      s = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(
        navigator.userAgent
      ),
      r = 0;
    function a() {
              ...
              (
                ...
                : ((c = s / n),
                  ...
                  "top" === e["object-position-y"]
                    ...
                    ? (i.marginTop = Math.round(r - c) + "px")
                    : (i.marginTop = Math.round((r - c) / 2) + "px")),
              t.autoplay && t.play();
          }
        }
        (n && o) ||
    ...
    !(function (n, o) {
      ...
      (function (t, e) {
        ...
        (u = {
          ...
          (c =
            "function" == typeof (h = e)
              ? h.call(u.exports, i, u.exports, u)
              : h),
          (u.loaded = !0),
              ...
              (i.navCompanionSelect = function (t) {
                ...
                if (e) {
                  var i,
                    ...
                    s = o + e.length - 1,
                    r = Math.floor(
                      (s - (i = o)) * this.navCompanion.cellAlign + i
                    );
                  if (
                  ...
                  return (
                    ...
                    this.each(function () {
                      if (null !== o) {
                        ...
                        var f =
                          (t.isFunction(r.offset) && r.offset(h, d)) ||
                          r.offset;
                        t.each(r.axis.split(""), function (t, i) {
                          ...
                          r.limit &&
                            /^\d+$/.test(p[s]) &&
                            (p[s] = p[s] <= 0 ? 0 : Math.min(p[s], v)),
                            !t &&
                              r.axis.length > 1 &&
                              (g === p[s]
                                ? (p = {})
                                : a && (m(r.onAfterFirst), (p = {})));
                        }),
                          m(r.onAfter);
                      }
                      function m(e) {
                    ...
                    if (i.enabled && e.supportsTransition) {
                      ...
                      h("BuildControls" + n, function () {
                        ...
                        h("BeforeClose" + n, function () {
                          if (e._allowZoom()) {
                            if (
                              (clearTimeout(o), (e.st.removalDelay = r), !t)
                            ) {
      ...
      (function () {
        ...
        function s(t) {
          (this.element = t),
            ...
            (e += 1),
            n.windowContext ||
              ((n.windowContext = !0), (n.windowContext = new s(window))),
              ...
              for (var a in this.waypoints[s]) {
                ...
                d.element !== d.element.window &&
                  ...
                  !g && c && h
                    ...
                    : ((!g && u) || (g && r.oldScroll >= d.triggerPoint)) &&
          ...
          if ("shown" == n.Status || "appearing" == n.Status) {
            ...
            r()
              ? (n.$tooltip
                ...
                n.options.speed > 0 && n.$tooltip.delay(n.options.speed),
                n.$tooltip.queue(s))
              : n.$tooltip.stop().fadeOut(n.options.speed, s);
        ...
        reposition: function () {
          ...
          if (0 !== t("body").find(i.$tooltip).length) {
            ...
            function O() {
              ...
              T - i < 0 && ((n = T - i), (T = i)),
                T + r - i > o && ((n = T - (o + i - r)), (T = o + i - r));
            }
            function D(i, n) {
              s.offset.top - t(e).scrollTop() - a - P - 12 < 0 &&
                n.indexOf("top") > -1 &&
                (A = i),
                s.offset.top + s.dimension.height + a + 12 + P >
                  t(e).scrollTop() + t(e).height() &&
                  n.indexOf("bottom") > -1 &&
                  ((A = i), (j = s.offset.top - a - P - 12));
            }
            if ("top" == A) {
            ...
            if (
              ...
              "top-right" == A &&
                ((T = s.offset.left + s.dimension.width + I - r),
                (j = s.offset.top - a - P - 12),
                O(),
                D("bottom-right", "top-right")),
              "bottom" == A &&
                ((Q = s.offset.left + r - (s.offset.left + s.dimension.width)),
              ...
              if (((j = s.offset.top - L / 2 - P), T < 0 && _ + r > o)) {
                ...
                T < 0 &&
                  ((T = s.offset.left + I + s.dimension.width + 12),
                  (n = "left"));
            }
            if (
              ("right" == A &&
                ...
                T + r > o && _ < 0
                  ? ((M = 2 * parseFloat(i.$tooltip.css("border-width"))),
                    ...
                    (a = i.$tooltip.outerHeight(!1)),
                    (L =
                      s.offset.top + a - (s.offset.top + s.dimension.height)),
                    (j = s.offset.top - L / 2 - P))
                  : T + r > o &&
                    ((T = s.offset.left - I - r - 12), (n = "right"))),
              i.options.arrow)
            ) {
              ...
              if (
                ...
                "bottom" == A || "bottom-left" == A || "bottom-right" == A
                  ? ((W = parseFloat(i.$tooltip.css("border-top-width"))),
                    (N = i.$tooltip.css("border-top-color")))
                  : "left" == A
                  ? ((W = parseFloat(i.$tooltip.css("border-right-width"))),
                    (N = i.$tooltip.css("border-right-color")))
                  : "right" == A
                  ? ((W = parseFloat(i.$tooltip.css("border-left-width"))),
                    (N = i.$tooltip.css("border-left-color")))
              ...
              if (0 !== W) {
                var V = "",
                  R = "border-color: " + N + ";";
                -1 !== F.indexOf("bottom")
                  ? (V = "margin-top: -" + Math.round(W) + "px;")
                  : -1 !== F.indexOf("top")
                  ? (V = "margin-bottom: -" + Math.round(W) + "px;")
                  : -1 !== F.indexOf("left")
                  ? (V = "margin-right: -" + Math.round(W) + "px;")
                  : -1 !== F.indexOf("right") &&
                    (V = "margin-left: -" + Math.round(W) + "px;"),
                  (H =
  ...
  function (t, e, i) {
    ...
    if (
      c &&
      (s.find(".header-wrapper").waypoint(
        function (t) {
      ...
      jQuery(window).on("scroll", function () {
        if (!Object(n.c)()) {
          ...
          t >= e.outerHeight() &&
            (t <= m
              ? (e.addClass("stuck"),
                s.removeClass("sticky-hide-on-scroll--active"))
              : (e.removeClass("stuck"),
        ...
        (o.prototype.THROTTLE_TIMEOUT = 100),
          ...
          (o.prototype._computeTargetAndRootIntersection = function (i, n) {
            if ("none" != t.getComputedStyle(i).display) {
              for (
                var o, s, r, l, h, u, d, p, f = a(i), m = c(i), g = !1;
                !g;
                ...
                if (
                  ...
                  v &&
                    ...
                    (p = l - r),
                    !(f = (d = (u = Math.min(o.right, s.right)) - h) >= 0 &&
                      p >= 0 && {
                        top: r,
                        bottom: l,
                        left: h,
              ...
              case "element":
                (y = g * o),
                  (i.style.transform = o
                    ...
                    : null),
                  (i.style.backfaceVisibility = o ? "hidden" : null),
                  void 0 !== i.dataset.parallaxFade &&
                    (i.style.opacity = o
                      ? ((e = 1 - v), e * (2 - e)).toFixed(2)
                      : null);
            }
        })(t);
    }
              ...
              return (function (t) {
                t.classList.add("parallax-active"),
                  (!document
                    ...
                    (t.classList &&
                      t.dataset &&
                      (n.push({ element: t, type: r(t) }), s(n[n.length - 1])));
              })(e);
            });
        });
  },
        ...
        e.addClass("current-dropdown"),
          (function (e) {
            ...
            if (a) {
              ...
              i.css(
                s(
                  s({ width: n }, c && { right: -(v.right - y.right) }),
            ...
            if (r) {
              ...
              i.css(
                s(
                  s({ width: C }, c && { right: -(w.right - x.right) - 15 }),
                  ...
                  d.on("click", "a:first", function (t) {
                    ...
                    l(e),
                      ...
                      (function (t, e) {
                        t.length &&
                          t.addClass(
                            "ux-body-overlay--".concat("click", "-active")
                          );
                      })(n),
          ...
          jQuery(
            ...
            l.off("click").on("click", function (t) {
              ...
              r.attr("aria-expanded", "true"),
                ...
                s.css(
                  "transform",
                  "translateX(".concat(u ? "" : "-").concat(100 * h, "%)")
                ),
              ...
              d.find(".toggle").on("click", function () {
                s.css(
                  "transform",
                  "translateX(".concat(u ? "" : "-").concat(100 * (h - 1), "%)")
                ),
                  i(o),
                  (p = setTimeout(function () {
                ...
                jQuery(a)
                  ...
                  .on("click", function (t) {
                    ...
                    if (e) {
                      ...
                      jQuery.scrollTo(s, { duration: 500, axis: "y" }),
              ...
              (o.remaining = o.duration - e),
                o.useEasing
                  ? o.countDown
                    ? (o.frameVal =
                        o.startVal -
                        o.easingFn(e, 0, o.startVal - o.endVal, o.duration))
                    : (o.frameVal = o.easingFn(
                        e,
                        o.startVal,
                        o.endVal - o.startVal,
                        o.duration
                  ...
                  : o.countDown
                  ? (o.frameVal =
                      o.startVal - (o.startVal - o.endVal) * (e / o.duration))
                  : (o.frameVal =
                      o.startVal + (o.endVal - o.startVal) * (e / o.duration)),
                o.countDown
                  ? (o.frameVal = o.frameVal < o.endVal ? o.endVal : o.frameVal)
                  : (o.frameVal =
                      o.frameVal > o.endVal ? o.endVal : o.frameVal),
                (o.frameVal = Number(
                  o.frameVal.toFixed(o.options.decimalPlaces)
                )),
                o.printValue(o.frameVal),
                e < o.duration
                  ? (o.rAF = requestAnimationFrame(o.count))
                  : null !== o.finalEndVal
                  ? o.update(o.finalEndVal)
          ...
          i.waypoint({
            handler: function (t) {
              if (!jQuery(this.element).hasClass("active")) {
                ...
                new o(i.get(0), e, { decimalPlaces: 0, duration: 4 }).start(),
                  i.addClass("active");
              }
            },
            offset: "100%",
